...
export default function GenerateAI() {
    ...
    const isGeneration = useAppStore(state=> state.isGenerating)
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="relative">
            ...
            <button 
              type="submit" 
              aria-label="Enviar"
              className={`cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2 ${isGeneration ? ' cursor-not-allowed opacity-50 ' : '' }`}
        ...
        {isGeneration && <p className="text-center animate-wiggle">Generando...</p>}
